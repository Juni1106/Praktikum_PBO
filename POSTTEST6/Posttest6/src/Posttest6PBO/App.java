...
public class App {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println(" || 7. Hitung Total Biaya Semua Ekskul  || ");
    ...
    private static void hitungTotalBiayaSemuaEkskul() {
        double totalBiaya = 0;
        for (Ekstrakulikuler ekstrakulikuler : ekstrakulikulerList) {
            totalBiaya += ekstrakulikuler.hitungBiaya();
        }
        System.out.println("Total biaya semua ekstrakulikuler: " + totalBiaya);
    }
}
